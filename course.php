             ...
             <section class="course__hard">
                 ...
                 <section class="course_hard_front_back">
                     ...
                     <article class="course__hard__back">
                         ...
                         <a href="<?php echo $lang['HardSkillPHPUNIT']; ?>" target="_blank"><img class="course__hard__back__img logo__phpunit" src="img/skills__phpunit.svg" alt=""></a>
                         <a href="<?php echo $lang['HardSkillMYSQL']; ?>" target="_blank"><img class="course__hard__back__img logo__mysql" src="img/skills__mysql.svg" alt=""></a>
             ...
             <section class="course__soft margBot0">
                 ...
                 <section class="agile__remote">
                     <article class="agile-method">
                         ...
                         <h6 class="course__soft__agile__title skill__title">Agile<br> Tools</h6>
                         <a href="<?php echo $lang['HardSkillTRELLO']; ?>" target="_blank"><img class="course__soft__agile__img logo__trello" src="img/skills__trello.svg" alt="trello logo"></a>
                     </article>
