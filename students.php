<section id="students" class="students">
    ...
    <div class="fluid1">
        <svg id="students__blob__purple__bottom" viewBox="0 0 1440 1344">
    ...
    <svg id="students__blob__orange__bottom" viewBox="95 -95 1015 896">
    ...
    <svg id="students__blob__yellow__bottom" viewBox="110 -170 572 519">
