        ...
        <section class="student__wrapper responsive slider">
            ...
            <section class="student__card__name__container">
                ...
                <section class="students__card__social">
                    <a class="students__card__social__item" href="http://www.decoz.be" target="_blank"><img class="students__card__social__item__img" src="img/card__cv.svg" alt="cv icon"></a>
                    <a class="students__card__social__item" href="https://github.com/AADecoz" target="_blank"><img class="students__card__social__item__img" src="img/card__website.svg" alt="website icon"></a>
            ...
            <article data-slick-index="2" class="students__card">
                ...
                <section class="student__card__name__container">
                    ...
                    <section class="students__card__social">
                        <!--a class="students__card__social__item" href="" target="_blank"><img class="students__card__social__item__img" src="img/card__cv.svg" alt="cv icon"></a-->
                        <a class="students__card__social__item" href="https://www.arnesneyers.be" target="_blank"><img class="students__card__social__item__img" src="img/card__website.svg" alt="website icon"></a>
...
<!--                        <a class="students__card__social__item" href="" target="_blank"><img class="students__card__social__item__img" src="img/card__cv.svg" alt="cv icon"></a>-->
<!--                        <a class="students__card__social__item" href="" target="_blank"><img class="students__card__social__item__img" src="img/card__website.svg" alt="website icon"></a>-->
                        <a class="students__card__social__item" href="www.linkedin.com/in/geertrumen" target="_blank"><img class="students__card__social__item__img" src="img/card__linkedin.svg" alt="linkedin icon"></a>
                    </section>
                </section>
            </article>
...
<!--                    <a class="students__card__social__item" href="" target="_blank"><img class="students__card__social__item__img" src="img/card__website.svg" alt="website icon"></a>-->
    ...
    <path class="yellow" d="M275.858 270.657C245.535 269.859 215.212 269.062 190.79 257.493C166.369 245.925 147.849 223.386 123.224 207.031C98.396 190.675 67.8692 180.303 54.2338 158.962C40.395 137.42 43.8547 104.909 37.7494 76.7855C31.644 48.6622 16.1771 24.7274 0.710175 0.992065H275.858V270.657Z" fill="#FBAE3C"/>
    </svg>

    <svg id="students__blob__purple__bottom" viewBox="0 0 2040 1244">
    <path class="purple" d="M0 0.497864C107.471 143.562 214.942 286.295 389.631 297.885C564.319 309.807 806.604 189.925 905.341 256.821C1004.08 324.048 959.646 577.721 967.621 730.389C975.976 883.388 1037.12 935.05 1141.17 1020.49C1245.6 1105.6 1392.95 1224.82 1540.29 1343.71H0V0.497864Z" fill="#3D3056"/>
    </svg>

    <svg id="students__blob__orange__bottom" viewBox="0 0 1765 796">
    <path class="orange" d="M-12.2946 0.641357C59.4617 96.005 130.838 191.369 247.395 198.984C363.951 206.6 525.308 126.799 590.989 171.501C657.051 216.203 627.437 385.407 632.752 487.393C638.067 589.048 679.071 623.485 748.549 680.438C818.027 737.392 915.98 816.53 1014.31 896H-12.2946V0.641357Z" fill="#E1685E"/>
    </svg>
